...
class DashGUI: 
    def __init__(self, master):
        ...
        #Speed slider
        self.speedSlide = Scale(master, from_=0, to=10, length=1000, resolution=0.001, borderwidth=0, orient=HORIZONTAL, bg="grey")
        self.speedSlide.grid(row=3, column=0, columnspan=4, sticky=S)
    ...
    def update(self):
        GPSSpeed = DM.DataManager.getGPSSpeed()
        ...
        if simData is not None:
            self.speedSlide.set(simData[posI].VSpeedIn - DM.DataManager.getGPSSpeed())
